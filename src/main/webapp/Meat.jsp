    ...
    <nav class="navbar justify-content-center bg-secondary">
          ...
          <div class="btn-group dropstart" style="position: absolute; right: 50px; top: 23px;">
            <button class="btn" type="button" data-bs-toggle="dropdown" aria-expanded="false">
              <img src="Images/user-solid.svg" alt="Profile" class="img-fluid" style="height: 50px; position: absolute; top:0px;">
            </button>
            <ul class="dropdown-menu">
...
<section class="category" id="category">
    <h1 class="heading">Meat Products</h1>
    ...
    <div class="box-container">
        <div class="box">
            ...
            <h3>Fresh Chicken</h3>
            <p class="price">Rs.1,150.00/KG</p>
        ...
        <div class="box">
            <img src="Images/chickendrums.jpg">
            <h3>Chicken Drumsticks</h3>
            <p class="price">Rs.1,790.00/KG</p>
            <a href="Editproducts.jsp" class="btn"><div class="fa fa-shopping-cart" id="cart-btn"></div>Edit Details</a>
            <button class="btn" onclick="deleteProduct()"><div class="fa fa-shopping-cart" id="cart-btn"></div>Delete Product</button>
        </div>
        ...
        <div class="box">
            ...
            <h3>Beef Cubes</h3>
            <p class="price">Rs.2,870.00/KG</p>
            <a href="Editproducts.jsp" class="btn"><div class="fa fa-shopping-cart" id="cart-btn"></div>Edit Details</a>
            <button class="btn" onclick="deleteProduct()"><div class="fa fa-shopping-cart" id="cart-btn"></div>Delete Product</button>
        </div>
        ...
        <div class="box">
            ...
            <h3>Mutton</h3>
            <p class="price">Rs.4,500.00/KG</p>
            <a href="Editproducts.jsp" class="btn"><div class="fa fa-shopping-cart" id="cart-btn"></div>Edit Details</a>
            <button class="btn" onclick="deleteProduct()"><div class="fa fa-shopping-cart" id="cart-btn"></div>Delete Product</button>
        </div>
