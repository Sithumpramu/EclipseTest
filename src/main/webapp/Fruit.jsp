...
<section class="category" id="category">
    ...
    <div class="box-container">
      <div class="box">
        <img src="Images/redapple.jpg" />
        <h3>Red Apple</h3>
        <p class="price">Rs.2,210.00/KG</p>
      ...
      <div class="box">
        <img src="Images/gapple.jpg" />
        <h3>Green Apple</h3>
        <p class="price">Rs.2,220.00/KG</p>
        <a href="Editproducts.jsp" class="btn"><div class="fa fa-shopping-cart" id="cart-btn"></div>Edit Details</a>
        <button class="btn" onclick="deleteProduct()"><div class="fa fa-shopping-cart" id="cart-btn"></div>Delete Product</button>
      </div>
      ...
      <div class="box">
        ...
        <h3>Banana - Seeni</h3>
        <p class="price">Rs.230.00/KG</p>
        <a href="Editproducts.jsp" class="btn"><div class="fa fa-shopping-cart" id="cart-btn"></div>Edit Details</a>
        <button class="btn" onclick="deleteProduct()"><div class="fa fa-shopping-cart" id="cart-btn"></div>Delete Product</button>
      </div>

      <div class="box">
        <img src="Images/grapesb.jpg" />
        <h3>Grapes - Black</h3>
        <p class="price">Rs.3,520.00/KG</p>
        <a href="Editproducts.jsp" class="btn"><div class="fa fa-shopping-cart" id="cart-btn"></div>Edit Details</a>
        <button class="btn" onclick="deleteProduct()"><div class="fa fa-shopping-cart" id="cart-btn"></div>Delete Product</button>
      </div>

      <div class="box">
        <img src="Images/grapesred.jpg" />
        <h3>Grapes - Red</h3>
        <p class="price">Rs.2,100.00/KG</p>
        <a href="Editproducts.jsp" class="btn"><div class="fa fa-shopping-cart" id="cart-btn"></div>Edit Details</a>
        <button class="btn" onclick="deleteProduct()"><div class="fa fa-shopping-cart" id="cart-btn"></div>Delete Product</button>
      </div>
      ...
      <div class="box">
        ...
        <h3>Mango</h3>
        <p class="price">Rs.780.00/KG</p>
        <a href="Editproducts.jsp" class="btn"><div class="fa fa-shopping-cart" id="cart-btn"></div>Edit Details</a>
        <button class="btn" onclick="deleteProduct()"><div class="fa fa-shopping-cart" id="cart-btn"></div>Delete Product</button>
      </div>

      <div class="box">
        <img src="Images/mangosteen.jpg" />
        <h3>Mangosteen</h3>
        <p class="price">Rs.4,010.00/KG</p>
        <a href="Editproducts.jsp" class="btn"><div class="fa fa-shopping-cart" id="cart-btn"></div>Edit Details</a>
        <button class="btn" onclick="deleteProduct()"><div class="fa fa-shopping-cart" id="cart-btn"></div>Delete Product</button>
      </div>
