...
<section class="category" id="category">
    <h1 class="heading">Household products</h1>

    <div class="box-container">
      <div class="box">
        <img src="Images/soapdetol.jpg" />
        <h3>Detol Soap 100g</h3>
        <p class="price">Rs.185.00/Unit</p>
      ...
      <div class="box">
        <img src="Images/soapk.jpg" />
        <h3>Khomba Soap 90g</h3>
        <p class="price">Rs.170.00/Unit</p>
        <a href="Editproducts.jsp" class="btn"><div class="fa fa-shopping-cart" id="cart-btn"></div>Edit Details</a>
        <button class="btn" onclick="deleteProduct()"><div class="fa fa-shopping-cart" id="cart-btn"></div>Delete Product</button>
      </div>

      <div class="box">
        <img src="Images/soapl.jpg" />
        <h3>Lifeboy Soap 100g</h3>
        <p class="price">Rs.160.00/Unit</p>
        <a href="Editproducts.jsp" class="btn"><div class="fa fa-shopping-cart" id="cart-btn"></div>Edit Details</a>
        <button class="btn" onclick="deleteProduct()"><div class="fa fa-shopping-cart" id="cart-btn"></div>Delete Product</button>
      </div>

      <div class="box">
        <img src="Images/soaplux.jpg" />
        <h3>Lux Soap 100g</h3>
        <p class="price">Rs.175.00/Unit</p>
        <a href="Editproducts.jsp" class="btn"><div class="fa fa-shopping-cart" id="cart-btn"></div>Edit Details</a>
        <button class="btn" onclick="deleteProduct()"><div class="fa fa-shopping-cart" id="cart-btn"></div>Delete Product</button>
      </div>

      <div class="box">
        <img src="Images/rin.jpg" />
        <h3>Rin Washing Powder 1kg</h3>
        <p class="price">Rs.399.00/Unit</p>
        <a href="Editproducts.jsp" class="btn"><div class="fa fa-shopping-cart" id="cart-btn"></div>Edit Details</a>
        <button class="btn" onclick="deleteProduct()"><div class="fa fa-shopping-cart" id="cart-btn"></div>Delete Product</button>
      </div>
      ...
      <div class="box">
        ...
        <h3>Sunlight detgnt/Pwdr 1kg</h3>
        <p class="price">Rs.43.00/Unit</p>
        <a href="Editproducts.jsp" class="btn"><div class="fa fa-shopping-cart" id="cart-btn"></div>Edit Details</a>
        <button class="btn" onclick="deleteProduct()"><div class="fa fa-shopping-cart" id="cart-btn"></div>Delete Product</button>
      </div>

      <div class="box">
        <img src="Images/comfirt.jpg" />
        <h3>Comfirt Fabric Conditioner 220ml</h3>
        <p class="price">Rs.390.00/Unit</p>
        <a href="Editproducts.jsp" class="btn"><div class="fa fa-shopping-cart" id="cart-btn"></div>Edit Details</a>
        <button class="btn" onclick="deleteProduct()"><div class="fa fa-shopping-cart" id="cart-btn"></div>Delete Product</button>
      </div>
      ...
      <div class="box">
        ...
        <h3>Vim Dishwash Bar 200g</h3>
        <p class="price">Rs.135.00/Unit</p>
        <a href="Editproducts.jsp" class="btn"><div class="fa fa-shopping-cart" id="cart-btn"></div>Edit Details</a>
        <button class="btn" onclick="deleteProduct()"><div class="fa fa-shopping-cart" id="cart-btn"></div>Delete Product</button>
      </div>

      <div class="box">
        <img src="Images/vimli.jpg" />
        <h3>Vim Dishwash Liquid 500ml</h3>
        <p class="price">Rs.340.00/Unit</p>
        <a href="Editproducts.jsp" class="btn"><div class="fa fa-shopping-cart" id="cart-btn"></div>Edit Details</a>
        <button class="btn" onclick="deleteProduct()"><div class="fa fa-shopping-cart" id="cart-btn"></div>Delete Product</button>
      </div>
    </div>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col text-center">
              <h4>Quick Links</h4>
              <ul class="list-unstyled">
                <li><a href="Productlist.">Product category</a></li>
