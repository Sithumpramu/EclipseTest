...
<body>
  <body class="bg-light">
    ...
    <section class="category" id="category">
      <h1 class="heading">Bakery Products</h1>

      <div class="box-container">
        <div class="box">
          <img src="Images/bread.jpg" />
          <h3>Sandwitch Bread 450g</h3>
          <p class="price">Rs.280.00/Unit</p>
        ...
        <div class="box">
          <img src="Images/kisses.jpg" />
          <h3>Kisses</h3>
          <p class="price">Rs.325.00/Unit</p>
          <a href="Editproducts.jsp" class="btn"><div class="fa fa-shopping-cart" id="cart-btn"></div>Edit Details</a>
          <button class="btn" onclick="deleteProduct()"><div class="fa fa-shopping-cart" id="cart-btn"></div>Delete Product</button>
        </div>
        ...
        <div class="box">
          ...
          <h3>Marshmallow Packet 200g</h3>
          <p class="price">Rs.450.00/Unit</p>
          <a href="Editproducts.jsp" class="btn"><div class="fa fa-shopping-cart" id="cart-btn"></div>Edit Details</a>
          <button class="btn" onclick="deleteProduct()"><div class="fa fa-shopping-cart" id="cart-btn"></div>Delete Product</button>
        </div>

        <div class="box">
          <img src="Images/chococake.jpg" />
          <h3>Chocolate Cake 1KG</h3>
          <p class="price">Rs.1,125.00/KG</p>
          <a href="Editproducts.jsp" class="btn"><div class="fa fa-shopping-cart" id="cart-btn"></div>Edit Details</a>
          <button class="btn" onclick="deleteProduct()"><div class="fa fa-shopping-cart" id="cart-btn"></div>Delete Product</button>
        </div>

        <div class="box">
          <img src="Images/buttercake.jpeg" />
          <h3>Butter Cake 1KG</h3>
          <p class="price">Rs.930.00/KG</p>
          <a href="Editproducts.jsp" class="btn"><div class="fa fa-shopping-cart" id="cart-btn"></div>Edit Details</a>
          <button class="btn" onclick="deleteProduct()"><div class="fa fa-shopping-cart" id="cart-btn"></div>Delete Product</button>
        </div>

        <div class="box">
          <img src="Images/donut.jpeg" />
        ...
        <div class="box">
          <img src="Images/donut2.jpeg" />
          <h3>Donut / Stawberry</h3>
          <p class="price">Rs.160.00/Unit</p>
          <a href="Editproducts.jsp" class="btn"><div class="fa fa-shopping-cart" id="cart-btn"></div>Edit Details</a>
          <button class="btn" onclick="deleteProduct()"><div class="fa fa-shopping-cart" id="cart-btn"></div>Delete Product</button>
        </div>
