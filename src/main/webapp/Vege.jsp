...
<head>
    ...
    <link href="bootstrap-5.3.2-dist/css/bootstrap.css" rel="stylesheet">
     <title>Vegetables products</title>
</head>
<body>
  <body class="bg-light">
    <nav class="navbar justify-content-center bg-secondary">
          ...
          <div class="dropdown-center">
              ...
              <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="Ediproducts.jsp">Edit products</a></li>
              </ul>
            </div>
    ...
    <section class="category" id="category">
      ...
      <div class="box-container">
        <div class="box">
          ...
          <h3>Organic Green Benas</h3>
          <p class="price">Rs.920.00/KG</p>
        ...
        <div class="box">
          ...
          <p class="price">Rs.550.00/KG</p>
          <a href="Editproducts.jsp" class="btn"><div class="fa fa-shopping-cart" id="cart-btn"></div>Edit Details</a>
          <button class="btn" onclick="deleteProduct()"><div class="fa fa-shopping-cart" id="cart-btn"></div>Delete Product</button>
        </div>

        <div class="box">
          <img src="Images/brinjol.jpeg" />
          <h3>Organic Brinjals</h3>
          <p class="price">Rs.800.00/KG</p>
          <a href="Editproducts.jsp" class="btn"><div class="fa fa-shopping-cart" id="cart-btn"></div>Edit Details</a>
          <button class="btn" onclick="deleteProduct()"><div class="fa fa-shopping-cart" id="cart-btn"></div>Delete Product</button>
        </div>

        <div class="box">
          <img src="Images/chili.jpeg" />
          <h3>Organic Green Chilies</h3>
          <p class="price">Rs.1,200.00/KG</p>
          <a href="Editproducts.jsp" class="btn"><div class="fa fa-shopping-cart" id="cart-btn"></div>Edit Details</a>
          <button class="btn" onclick="deleteProduct()"><div class="fa fa-shopping-cart" id="cart-btn"></div>Delete Product</button>
        </div>
        ...
        <div class="box">
          ...
          <h3>Organic Pumpkin</h3>
          <p class="price">Rs.280.00/KG</p>
          <a href="Editproducts.jsp" class="btn"><div class="fa fa-shopping-cart" id="cart-btn"></div>Edit Details</a>
          <button class="btn" onclick="deleteProduct()"><div class="fa fa-shopping-cart" id="cart-btn"></div>Delete Product</button>
        </div>
