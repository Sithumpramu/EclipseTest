...
<body>
  ...
  <section class="category" id="category">
    ...
    <div class="box-container">
      <div class="box">
        <img src="Images/cheesewed.jpeg" />
        <h3>H/Cow Cheese Regular 200g</h3>
        <p class="price">Rs.1,690.00/Unit</p>
      ...
      <div class="box">
        <img src="Images/cheeseslice.jpeg" />
        <h3>H/Cow Cheddar Slices 200g</h3>
        <p class="price">Rs.1,680.00/Unit</p>
        <a href="Editproducts.jsp" class="btn"><div class="fa fa-shopping-cart" id="cart-btn"></div>Edit Details</a>
        <button class="btn" onclick="deleteProduct()"><div class="fa fa-shopping-cart" id="cart-btn"></div>Delete Product</button>
      </div>

      <div class="box">
        <img src="Images/cheesespred.jpg" />
        <h3>Kotmale Cheese Spread 175g</h3>
        <p class="price">Rs.700.00/Unit</p>
        <a href="Editproducts.jsp" class="btn"><div class="fa fa-shopping-cart" id="cart-btn"></div>Edit Details</a>
        <button class="btn" onclick="deleteProduct()"><div class="fa fa-shopping-cart" id="cart-btn"></div>Delete Product</button>
      </div>

      <div class="box">
        <img src="Images/buuter.jpg" />
        <h3>Anchor Butter 227g</h3>
        <p class="price">Rs.1,590.00/Unit</p>
        <a href="Editproducts.jsp" class="btn"><div class="fa fa-shopping-cart" id="cart-btn"></div>Edit Details</a>
        <button class="btn" onclick="deleteProduct()"><div class="fa fa-shopping-cart" id="cart-btn"></div>Delete Product</button>
      </div>
      ...
      <div class="box">
        ...
        <h3>Newdale Fresh Milk 1l</h3>
        <p class="price">Rs.550.00/Unit</p>
        <a href="Editproducts.jsp" class="btn"><div class="fa fa-shopping-cart" id="cart-btn"></div>Edit Details</a>
        <button class="btn" onclick="deleteProduct()"><div class="fa fa-shopping-cart" id="cart-btn"></div>Delete Product</button>
      </div>
      ...
      <div class="box">
        ...
        <h3>Newdale Set Yogurt 80g</h3>
        <p class="price">Rs.80.00/Unit</p>
        <a href="Editproducts.jsp" class="btn"><div class="fa fa-shopping-cart" id="cart-btn"></div>Edit Details</a>
        <button class="btn" onclick="deleteProduct()"><div class="fa fa-shopping-cart" id="cart-btn"></div>Delete Product</button>
      </div>
      ...
      <div class="box">
        ...
        <h3>Astra Fat Spread 250g Tub</h3>
        <p class="price">Rs.495.00/Unit</p>
        <a href="Editproducts.jsp" class="btn"><div class="fa fa-shopping-cart" id="cart-btn"></div>Edit Details</a>
        <button class="btn" onclick="deleteProduct()"><div class="fa fa-shopping-cart" id="cart-btn"></div>Delete Product</button>
      </div>
    </div>
